...
def get_community_context_service(request: Request) -> CommunityContextService:
    """Return the app-scoped community context service."""
    return cast(CommunityContextService, request.app.state.community_context_service)
